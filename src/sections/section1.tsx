...
const Section1 = (): JSX.Element => {
    return (
        <div className="section h-screen bg-gradient-to-tl from-orange-900 from-25% via-orange-700 via-50% to-yellow-500 to-100% text-white">
            ...
            {/* GRID PRINCIPAL */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-20 h-full p-3 md:p-12">
                ...
                <div className="col-span-1 flex flex-col items-start justify-center p-6 md:p-10 text-center md:text-left">
                    ...
                    <h1 className="text-5xl md:text-8xl font-extrabold tracking-tight mb-4 drop-shadow-[0_2px_6px_rgba(255,255,255,0.65)] animate-fade-in-up">
                        LUMIERS
                    </h1>
                    ...
                    <button
                        className="
                            flex items-center gap-2
                            px-4 py-3               /* MOBILE ONLY */
                            md:px-6 md:py-2         /* DESKTOP IGUAL */
                            rounded-full   /* MOBILE MÁS SUAVE */
                            text-white font-medium
                            text-sm md:text-base    /* MOBILE MÁS CHICO */
                            bg-gradient-to-r from-lime-700 via-lime-600 to-lime-500
                            transform transition-all duration-300 ease-in-out
                            hover:-translate-y-1 hover:opacity-85 cursor-pointer
                            shadow-md active:scale-95   /* MOBILE FEEL */
                        "
                    >
